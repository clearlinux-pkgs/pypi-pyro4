...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707134647
...
cp %{_builddir}/Pyro4-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pyro4/28687233f8a681dc4d5979e85b98d6231a800839 || :
cp %{_builddir}/Pyro4-%{version}/docs/source/license.rst %{buildroot}/usr/share/package-licenses/pypi-pyro4/d4c0c8299052f2e2089f956acbbb99f2a6ea77c1 || :
